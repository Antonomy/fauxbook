...
export default function PhotosPage ({ user }) {
  ...
  return (
    ...
    <main className={styles.main}>
      <input
        className={styles.input} type='text' placeholder='Insert Photo Here'
      ...
      />
      <input
        className={styles.input} type='text' alt='caption' placeholder='Caption (Optional)'
        ...
        {photos.map(photo => {
          return (
            <div className={styles.photo} key={photo._id}>
              <img className={styles.title} src={`${photo.title}`} alt='' />
